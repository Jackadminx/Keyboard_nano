...
// 产品信息
UINT8C MyProdInfo[] = {0x1C, 0x03, 'K', 0, 'e', 0, 'y', 0, 'b', 0, 'o', 0, 'a', 0, 'r', 0, 'd', 0, ' ', 0, 'N', 0, 'a', 0, 'n', 0, 'o', 0,}; //字符串描述符 Keyboard Nano 13*2bit + 2bit
...
UINT8 Get_mode[12] = {0, 0, 0, 0, 0, 10, 0, 0, 0, 0, 0, 0};
//# buffer[0] = 0  # 预设模式
//# buffer[1] = 0  # 保留
//# buffer[2] = 4  # 保留
//# buffer[3] = 0  # led模式 0x00-0x06 0为关闭
//# buffer[4] = 2  # 多媒体键
...
//    if (KeyState[0] == 0)
//    {
//        if(SendHIDKey1[0] == 1) //标准键盘 1
//        {
//            SendHID[0] = 1;//report-id

//            if(SendHIDKey1[1] != 0) //该键使用了组合键才使用此位
//            {
//                SendHID[1] = SendHIDKey1[1];
//            }

//            SendHID[3] = SendHIDKey1[3];//标准按键
//        }

//    }
//    else if (KeyState[0] == 1) //按键松开
//    {
//        if(SendHIDKey1[0] == 1) //标准键盘
//        {
//            SendHID[0] = 1;
...
//        else if(SendHIDKey1[0] == 2 &&  BackState[0] == 0) //媒体键 1
//        {
//            if (Ready && Endp2Busy == 0) //枚举成功
//            {
//                Enp2BlukIn(ReleaseHIDKey1, 3);
//                return;
//            }
//        }
//    }
...
//    if (KeyState[1] == 0)
//    {
//        if(SendHIDKey2[0] == 1) //标准键盘 2
//        {
//            SendHID[0] = 1;//report-id

//            if(SendHIDKey2[1] != 0) //该键使用了组合键才使用此位
//            {
//                SendHID[1] |= SendHIDKey2[1];
//            }

//            SendHID[4] = SendHIDKey2[3];//标准按键
//        }
//        else if(SendHIDKey2[0] == 2)           //媒体键 1
//        {
//            if (Ready && Endp2Busy == 0) //枚举成功
//            {
//                Enp2BlukIn(SendHIDKey2, 3);
//                return;
//            }
//        }
//    }
...
//        else if(SendHIDKey2[0] == 2 &&  BackState[1] == 0)         //媒体键 1
//        {
//            if (Ready && Endp2Busy == 0) //枚举成功
//            {
//                Enp2BlukIn(ReleaseHIDKey2, 3);
//                return;
//            }
//        }
//    }
...
//        if(SendHIDKey3[0] == 1) //标准键盘 2
//        {
//            SendHID[0] = 1;//report-id

//            if(SendHIDKey3[1] != 0) //该键使用了组合键才使用此位
//            {
//                SendHID[1] |= SendHIDKey3[1];
//            }

//            SendHID[5] = SendHIDKey3[3];//标准按键
//        }
//        else if(SendHIDKey3[0] == 2)           //媒体键 1
//        {
//            if (Ready && Endp2Busy == 0) //枚举成功
//            {
//                Enp2BlukIn(SendHIDKey3, 3);
//                return;
//            }
//        }
//    }
...
//        else if(SendHIDKey3[0] == 2 &&  BackState[2] == 0)          //媒体键 1
//        {
//            if (Ready && Endp2Busy == 0) //枚举成功
//            {
//                Enp2BlukIn(ReleaseHIDKey3, 3);
//                return;
//            }
//        }
//    }
...
void main()
{
    ...
    GPIO_Init(PORT2, PIN4, MODE3); //P2.4上拉输入 RGB
